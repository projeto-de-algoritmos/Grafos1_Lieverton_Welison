...
print("""
 _        _    ____ ___ ____  ___ _   _ _____ ___          _____   ___  
| |      / \  | __ )_ _|  _ \|_ _| \ | |_   _/ _ \  __   _/__   \ / _ \ 
| |     / _ \ |  _ \| || |_) || ||  \| | | || | | | \ \ / /  / / | | | |
| |___ / ___ \| |_) | ||  _ < | || |\  | | || |_| |  \ V / / /__ | |_| |
|_____/_/   \_\____/___|_| \_\___|_| \_| |_| \___/    \_/ |_____(_)___/ 
...
pygame.init()
pygame.display.set_caption("Labirinto v2.0")
